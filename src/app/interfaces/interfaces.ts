...
export interface permisos {
    modulos: Array<permiso>,
    infoCompleta: boolean
}

export interface sedeRectoria {
    resp: boolean
}
...
export interface arraySedeEstudiante {
    data: Array<sedeEstudiantes>
}

export interface sedeEstudiantes {
    descRectoria: string,
    sede: string,
    sedeId: string,
}
...
export interface arrayAreas {
    areas: Array<areas>
}

export interface ButtonReaders {
    buttons: Array<ButtonReader>
}

export interface ButtonReader {
    name: string,
    id: string
}
